...
A modern password generator built with Python Flask, HTML5, CSS3, JavaScript and Python/Flask. This is my engineering project featuring a beautiful responsive interface and advanced security features.
